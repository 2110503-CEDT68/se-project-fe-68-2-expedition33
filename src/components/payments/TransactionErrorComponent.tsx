...
export default function TransactionErrorComponent({ errorType, message, visible = true }: TransactionErrorProps) {
  return (
    <div className="bg-background rounded-2xl border border-surface-border px-6 py-5 flex flex-col justify-start">
      {/* Title row — top-left */}
      <div className="flex items-center gap-3 mb-3">
        <div className="w-8 h-8 rounded-full border-2 border-button-red flex items-center justify-center flex-shrink-0">
